# Data and example terms

The Apache-2.0 software licence does not grant rights to third-party intelligence data, provider screenshots, trademarks or website content.
...
Public exports should contain only the bounded fields documented in `docs/DATA-CONTRACT.md`; raw provider responses and private analyst notes must remain private.
